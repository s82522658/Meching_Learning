...
/*store training data into ecoli strcuct*/
 	...
 	for(;i<lSize;i++){
 		if(buffer[i] == ','){
 			comma++;
 			if(seq < num_data){
 				if(comma >= 5 && comma <= 12) data[seq].attribute[comma-1]=atof(buf);
 				else if(comma >= 1 && comma < 3) data[seq].attribute[comma-1]=atoi(buf);
 				else if(comma == 3){
 					if(!strcmp(buf,"jan")) data[seq].attribute[comma-1]=0;
 					else if(!strcmp(buf,"feb")) data[seq].attribute[comma-1]=1;
 					else if(!strcmp(buf,"mar")) data[seq].attribute[comma-1]=2;
 					else if(!strcmp(buf,"apr")) data[seq].attribute[comma-1]=3;
 					else if(!strcmp(buf,"may")) data[seq].attribute[comma-1]=4;
 					else if(!strcmp(buf,"jun")) data[seq].attribute[comma-1]=5;
 					else if(!strcmp(buf,"jul")) data[seq].attribute[comma-1]=6;
 					else if(!strcmp(buf,"aug")) data[seq].attribute[comma-1]=7;
 					else if(!strcmp(buf,"sep")) data[seq].attribute[comma-1]=8;
 					else if(!strcmp(buf,"oct")) data[seq].attribute[comma-1]=9;
 					else if(!strcmp(buf,"nov")) data[seq].attribute[comma-1]=10;
 					else if(!strcmp(buf,"dec")) data[seq].attribute[comma-1]=11;
 					else printf("month error!\n");
 				}
 				else if(comma == 4){
 					if(!strcmp(buf,"mon")) data[seq].attribute[comma-1]=0;
 					else if(!strcmp(buf,"tue")) data[seq].attribute[comma-1]=1;
 					else if(!strcmp(buf,"wed")) data[seq].attribute[comma-1]=2;
 					else if(!strcmp(buf,"thu")) data[seq].attribute[comma-1]=3;
 					else if(!strcmp(buf,"fri")) data[seq].attribute[comma-1]=4;
 					else if(!strcmp(buf,"sat")) data[seq].attribute[comma-1]=5;
 					else if(!strcmp(buf,"sun")) data[seq].attribute[comma-1]=6;
 					else printf("day error!\n");
 				}
 			}
 			else{
 				if(comma >= 5 && comma <= 12) testdata[seq-num_data].attribute[comma-1]=atof(buf);
 				else if(comma >= 1 && comma < 3) testdata[seq-num_data].attribute[comma-1]=atoi(buf);
 				else if(comma == 3){
 					if(!strcmp(buf,"jan")) testdata[seq-num_data].attribute[comma-1]=0;
 					else if(!strcmp(buf,"feb")) testdata[seq-num_data].attribute[comma-1]=1;
 					else if(!strcmp(buf,"mar")) testdata[seq-num_data].attribute[comma-1]=2;
 					else if(!strcmp(buf,"apr")) testdata[seq-num_data].attribute[comma-1]=3;
 					else if(!strcmp(buf,"may")) testdata[seq-num_data].attribute[comma-1]=4;
 					else if(!strcmp(buf,"jun")) testdata[seq-num_data].attribute[comma-1]=5;
 					else if(!strcmp(buf,"jul")) testdata[seq-num_data].attribute[comma-1]=6;
 					else if(!strcmp(buf,"aug")) testdata[seq-num_data].attribute[comma-1]=7;
 					else if(!strcmp(buf,"sep")) testdata[seq-num_data].attribute[comma-1]=8;
 					else if(!strcmp(buf,"oct")) testdata[seq-num_data].attribute[comma-1]=9;
 					else if(!strcmp(buf,"nov")) testdata[seq-num_data].attribute[comma-1]=10;
 					else if(!strcmp(buf,"dec")) testdata[seq-num_data].attribute[comma-1]=11;
 					else printf("month error!\n");
 				}
 				else if(comma == 4){
 					if(!strcmp(buf,"mon")) testdata[seq-num_data].attribute[comma-1]=0;
 					else if(!strcmp(buf,"tue")) testdata[seq-num_data].attribute[comma-1]=1;
 					else if(!strcmp(buf,"wed")) testdata[seq-num_data].attribute[comma-1]=2;
 					else if(!strcmp(buf,"thu")) testdata[seq-num_data].attribute[comma-1]=3;
 					else if(!strcmp(buf,"fri")) testdata[seq-num_data].attribute[comma-1]=4;
 					else if(!strcmp(buf,"sat")) testdata[seq-num_data].attribute[comma-1]=5;
 					else if(!strcmp(buf,"sun")) testdata[seq-num_data].attribute[comma-1]=6;
 					else printf("day error!\n");
 				}
 			}
 			...
 			if(seq < num_data){
	 			...
	 			else data[seq].class=5;
	 			
	 			data[seq].index=seq;
 			}
 			else{
 				float temp=atof(buf);
 				if(temp == 0) testdata[seq-num_data].class=0; 				
	 			else if(temp > 0 && temp <= 1) testdata[seq-num_data].class=1;
	 			else if(temp > 1 && temp <= 10) testdata[seq-num_data].class=2;
	 			else if(temp > 10 && temp <= 100) testdata[seq-num_data].class=3;
	 			else if(temp > 100 && temp <= 1000) testdata[seq-num_data].class=4;
	 			else testdata[seq].class=5;
	 			testdata[seq-num_data].index=seq;
 			}
 			for(int j=0;j<15;j++) buf[j]=0;
 			comma=0;
 			cnt=0;
